...
public class CalculadoraCredito {
    ...
    public static void main(String[] args) {
        ...
        while (scanner.hasNextLine()) {
            ...
            List<String> listaTipoLigacao = new ArrayList<>();
            listaTipoLigacao.add("local");
            listaTipoLigacao.add("nacional");
            listaTipoLigacao.add("internacional");
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (listaTipoLigacao.contains(tipoLigacao)){
